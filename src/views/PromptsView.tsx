...
export const PromptsView: React.FC = () => {
    ...
    const PLATFORMS = [
        ...
        { id: 'Instagram', label: 'Insta', color: 'bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7]' },
    ...
    const PlatformIcon = ({ id, className }: { id: string, className?: string }) => {
        ...
        if (logo) {
            return (
                <div className={cn("w-5 h-5 bg-surface-lowest rounded-md p-1 shadow-sm border border-border/5", className)}>
